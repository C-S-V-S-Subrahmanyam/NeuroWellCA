          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="px-6 py-2 text-blue-600 font-semibold hover:bg-blue-50 rounded-lg transition-all"
              >
                Login
              </button>
              <button
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8 inline-block">
            <div className="glass-effect px-6 py-3 rounded-full">
              <span className="text-blue-600 font-semibold">🧠 AI-Powered Mental Health Support</span>
            </div>
          </div>
